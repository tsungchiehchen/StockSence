...
class GoogleNews:
    ...
    def __init__(self,lang="en",period="",start="",end="",encode="utf-8",region=None, https=""):
        self.__texts = []
        self.__links = []
        self.__results = []
        self.__totalcount = 0
    ...
    def get_news(self, key="",deamplify=False):
        ...
        if self.__https:
            self.url = 'https://news.google.com/search?q={}+after:{}+before:{}&hl={}'.format(key, start, end, self.__lang.lower())
        else:
            self.url = 'http://news.google.com/search?q={}+after:{}+before:{}&hl={}'.format(key, start, end, self.__lang.lower())
