...
df.to_csv("./dataset/MegaCap Stock Symbols", index=False)
...
df.to_csv("./dataset/LargeCap Stock Symbols", index=False)
...
df.to_csv("./dataset/MidCap Stock Symbols", index=False)
